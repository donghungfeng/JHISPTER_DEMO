...
import { getEntity, updateEntity, createEntity, reset } from './cap-de-tai.reducer';
...
export class CapDeTaiUpdate extends React.Component<ICapDeTaiUpdateProps, ICapDeTaiUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/cap-de-tai');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhispterDemoApp.capDeTai.home.createOrEditLabel">
              <Translate contentKey="jhispterDemoApp.capDeTai.home.createOrEditLabel">Create or edit a CapDeTai</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : capDeTaiEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="cap-de-tai-id">
                      <Translate contentKey="global.field.id">ID</Translate>
                    </Label>
                    <AvInput id="cap-de-tai-id" type="text" className="form-control" name="id" required readOnly />
                  </AvGroup>
                ) : null}
                <AvGroup>
                  <Label id="tenCapDeTaiLabel" for="cap-de-tai-tenCapDeTai">
                    <Translate contentKey="jhispterDemoApp.capDeTai.tenCapDeTai">Ten Cap De Tai</Translate>
                  </Label>
                  <AvField
                    id="cap-de-tai-tenCapDeTai"
                    type="text"
                    name="tenCapDeTai"
                    validate={{
                ...
                <Button tag={Link} id="cancel-save" to="/cap-de-tai" replace color="info">
