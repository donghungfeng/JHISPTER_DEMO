...
import { getEntity, deleteEntity } from './cap-de-tai.reducer';
...
export class CapDeTaiDeleteDialog extends React.Component<ICapDeTaiDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.capDeTaiEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhispterDemoApp.capDeTai.delete.question">
          <Translate contentKey="jhispterDemoApp.capDeTai.delete.question" interpolate={{ id: capDeTaiEntity.id }}>
